...
`PerceptionEventWindow` retains recent roster, movement, typing and chat evidence. It coalesces movement updates per user, preserves ordered social events, expires old entries and leaves chat text opaque.
