...
export { PerceptionEventWindow } from './perception/event-window.js';
export type { PerceptionEvent, PerceptionEventWindowOptions, PerceptionEventWindowSnapshot } from './perception/event-window.js';
export { CapabilityRegistry } from './capabilities/capability-registry.js';
export type { CapabilityContext, CapabilityDefinition, CapabilityRateLimit, CapabilityRegistryOptions, CapabilityResult } from './capabilities/capability-registry.js';
...
export { registerSocialGesture } from './capabilities/social-gesture.js';
export type { SocialGesture, SocialGestureCommand, SocialGestureInput } from './capabilities/social-gesture.js';
export { registerDance, registerPosture } from './capabilities/dance-posture.js';
export type { DanceCommand, DanceInput, PostureCommand, PostureInput } from './capabilities/dance-posture.js';
export { registerTransferItem, registerUseObject } from './capabilities/object-transfer.js';
export type { TransferItemCommand, TransferItemInput, UseObjectCommand, UseObjectInput } from './capabilities/object-transfer.js';
export { registerCreateRoom } from './capabilities/create-room.js';
export type { CreateRoomCommand, CreateRoomInput } from './capabilities/create-room.js';
export { registerOrient } from './capabilities/orient.js';
export type { OrientCommand, OrientInput } from './capabilities/orient.js';
export { registerBrowseShop, registerInspectUser, registerReadSelf } from './capabilities/inspect-data.js';
export type { BrowseShopCommand, BrowseShopInput, InspectUserCommand, InspectUserInput, ReadSelfCommand } from './capabilities/inspect-data.js';
export * from './session/recovery-token.js';
export { ActivityExecutor } from './activities/activity-executor.js';
export type { ActivityExecutionContext } from './activities/activity-executor.js';
